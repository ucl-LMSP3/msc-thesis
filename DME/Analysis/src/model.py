...
from src.utils import _zero_mean_function, get_mean_params, get_kernel_params


class DMEGP(torch.nn.Module):
    ...
    def step(self, train_X, train_y, train_Z, mean_optim, gp_optim, loss_fn_fixed,
        ...
        # GP
        train_y = train_y - self.mean_fn(train_X)
